export type View = 'dashboard' | 'records' | 'upload' | 'messages' | 'billing' | 'doctors' | 'health-profile';
...
export interface Vitals {
  ...
  temperature: Vital;
  glucose?: Vital;
  spo2?: Vital; // SpO2 (oxygen saturation)
  weight?: Vital; // Weight tracking for fluid status
  urineOutput?: Vital; // Daily urine output (CKD)
}
