...
export { default as FollowUpWorklist } from './FollowUpWorklist';
export { default as FollowUpCallsView } from './FollowUpCallsView';
...
export { default as DoctorDashboardWrapper } from './DoctorDashboardWrapper';
export { default as DepartmentProtectedRoute } from './DepartmentProtectedRoute';
export { default as DoctorProtectedRoute } from './DoctorProtectedRoute';
