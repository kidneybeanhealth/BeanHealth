            ...
            case "dashboard":
                return (
                    <CKDDashboard
                        ...
                        onNavigateToHealthProfile={() => setActiveView("health-profile")}
                    />
                );
            case "health-profile":
                return (
                    <HealthProfilePage
                        ...
                        onUpdatePatientInfo={async (updates) => {
                            try {
    ...
    return (
        <UrgentCreditsProvider userId={user?.id || ''} initialCredits={profile?.urgent_credits ?? 5}>
            <NotificationProvider userId={user?.id || ''} activeView={activeView} userRole="patient">
                <div className="h-screen page-shell flex flex-col md:flex-row overflow-hidden">
                    {/* Sidebar */}
                    ...
                    <div className="flex-1 flex flex-col min-w-0 w-full md:w-auto h-full overflow-hidden relative">
                        ...
                        <div className="pointer-events-none absolute top-2 sm:top-4 left-0 right-0 h-32 bg-gradient-to-b from-[#f8fbff]/90 via-[#f8fbff]/40 to-transparent z-30"></div>
                    </div>
