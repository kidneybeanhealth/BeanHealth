    ...
    return (
        <div className="bg-white dark:bg-[#8AC43C]/[0.08] backdrop-blur-md p-3 sm:p-4 rounded-xl sm:rounded-2xl shadow-[0_6px_16px_rgba(0,0,0,0.06)] dark:shadow-[0_0_15px_rgba(138,196,60,0.1)] transition-all duration-300 border border-transparent dark:border-[#8AC43C]/20">
            <div className="flex items-center justify-between mb-2 sm:mb-3">
                <h3 className="text-base sm:text-lg md:text-xl font-bold text-[#222222] dark:text-white">{t.fluid.title}</h3>
            ...
            <div className="mb-4 sm:mb-6">
                        ...
                        {isEditingTarget ? (
                            <div className="flex items-center gap-2">
                                <input
                                    ...
                                    className="w-20 px-2 py-1 text-sm bg-gray-50 dark:bg-[#8AC43C]/20 border border-gray-200 dark:border-[#8AC43C]/10 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#8AC43C]"
                                />
                                <button
                                    onClick={handleSaveTarget}
                                    className="px-2 py-1 text-xs bg-[#8AC43C] text-white dark:text-[#222222] rounded-lg hover:bg-[#7ab332]"
                                >
                                    Save
                                </button>
                                <button
                                    ...
                                    className="px-2 py-1 text-xs bg-gray-200 dark:bg-[#8AC43C]/20 text-gray-700 dark:text-gray-300 rounded-lg"
                                >
                                    Cancel
                                </button>
                            </div>
                            ...
                            >
                                {t.fluid.setTarget}: {dailyTarget} {t.fluid.ml} ✏️
                            </button>
                        )}
                    </div>
                </div>
                <div className="relative w-full h-4 bg-gray-100 dark:bg-[#8AC43C]/10 rounded-full overflow-hidden">
                    <div
                ...
                <div className="flex justify-between mt-1 text-xs text-gray-500 dark:text-gray-400">
                    <span>{progressPercent.toFixed(0)}{t.fluid.ofDailyTarget}</span>
            ...
            <div className="mb-4 sm:mb-6">
                ...
                <div className="flex gap-1.5 sm:gap-2 flex-wrap">
                    {(['water', 'juice', 'tea', 'coffee', 'milk', 'other'] as const).map((type) => {
            ...
            {/* Today's Log */}
            <div>
                <h4 className="text-[10px] sm:text-xs font-bold text-[#717171] dark:text-[#a0a0a0] mb-3 sm:mb-4 uppercase tracking-wider">{t.fluid.todayLog}</h4>
