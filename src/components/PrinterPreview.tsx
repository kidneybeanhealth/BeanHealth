...
const PrinterPreview: React.FC<PrinterPreviewProps> = ({
    ...
    const [localSettings, setLocalSettings] = useState<{ spacing: number; alignment: 'left' | 'center' | 'right' }>(data.settings || { spacing: 1, alignment: 'center' });
                ...
                >
                    ...
                    <div className="relative z-10 space-y-0 leading-none" style={{ fontSize: '12px' }}>
                        ...
                        <div className="text-center w-full font-extrabold py-1">
                            {tenant ? getTenantDisplayName(tenant).toUpperCase() : (data.hospitalName || 'HOSPITAL NAME')}
                        </div>
