...
const MobileBottomNav: React.FC<MobileBottomNavProps> = ({
    ...
    const navItems: { view: View; labelKey: keyof typeof t.nav; icon: React.ComponentType<{ className?: string }> }[] = [
        { view: 'dashboard', labelKey: 'home', icon: DashboardIcon },
        { view: 'health-profile', labelKey: 'healthProfile', icon: ClipboardList },
        { view: 'records', labelKey: 'records', icon: RecordsIcon },
        { view: 'messages', labelKey: 'chat', icon: MessagesIcon },
        { view: 'doctors', labelKey: 'doctors', icon: DoctorIcon },
        { view: 'billing', labelKey: 'billing', icon: BillingIcon },
    ];
