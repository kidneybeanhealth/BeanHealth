...
const Sidebar: React.FC<SidebarProps> = ({
  ...
  const navItems: { view: View; label: string; icon: React.ReactElement }[] = [
    { view: 'dashboard', label: t.nav.home, icon: <DashboardIcon /> },
    { view: 'health-profile', label: t.nav.healthProfile, icon: <ClipboardList className="w-5 h-5" /> },
    { view: 'records', label: t.nav.records, icon: <RecordsIcon /> },
    { view: 'upload', label: t.nav.upload, icon: <UploadIcon /> },
    { view: 'doctors', label: t.nav.doctors, icon: <DoctorIcon /> },
    { view: 'messages', label: t.nav.messages, icon: <MessagesIcon /> },
    { view: 'billing', label: t.nav.billing, icon: <BillingIcon /> },
  ];
