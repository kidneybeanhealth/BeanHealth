...
interface MobileDischargeCardInputProps {
    formData: {
    ...
    return (
        <div className="fixed inset-0 z-[60] flex flex-col bg-gray-50 overflow-hidden">
            ...
            <div className="flex-1 overflow-y-auto px-3 py-3 pb-28 space-y-3">
                ...
                {/* Discharge Card Header Fields: DoA / DoD / Claim / MLC */}
                <div className="bg-white rounded-xl p-3 shadow-sm border border-gray-100">
                    <h3 className="text-[10px] font-black text-gray-500 uppercase tracking-widest mb-2">Admission Details</h3>
                    <div className="grid grid-cols-2 gap-2">
                        <div>
                            <label className="text-[10px] font-bold text-gray-500 uppercase">Date of Admission</label>
                            <input type="date"
                                value={formData.dateOfAdmission || ''}
                                onChange={e => setFormData((prev: any) => ({ ...prev, dateOfAdmission: e.target.value }))}
                                className="w-full mt-1 px-2 py-2 border-2 border-gray-200 rounded-lg text-sm focus:ring-2 focus:ring-gray-400 outline-none"
                                readOnly={readOnly} />
                        </div>
                        <div>
                            <label className="text-[10px] font-bold text-gray-500 uppercase">Date of Discharge</label>
                            <input type="date"
                                value={formData.dateOfDischarge || ''}
                                onChange={e => setFormData((prev: any) => ({ ...prev, dateOfDischarge: e.target.value }))}
                                className="w-full mt-1 px-2 py-2 border-2 border-gray-200 rounded-lg text-sm focus:ring-2 focus:ring-gray-400 outline-none"
                                readOnly={readOnly} />
                        </div>
                        <div>
                            <label className="text-[10px] font-bold text-gray-500 uppercase">Claim</label>
                            <select
                                value={formData.claim || ''}
                                onChange={e => setFormData((prev: any) => ({ ...prev, claim: e.target.value }))}
                                className="w-full mt-1 px-2 py-2 border-2 border-gray-200 rounded-lg text-sm focus:ring-2 focus:ring-gray-400 outline-none font-bold"
                                disabled={readOnly}>
                                <option value="">--</option>
                        ...
                        <div>
                            <label className="text-[10px] font-bold text-gray-500 uppercase">MLC</label>
                            <select
                                value={formData.mlc || ''}
                                onChange={e => setFormData((prev: any) => ({ ...prev, mlc: e.target.value }))}
                                className="w-full mt-1 px-2 py-2 border-2 border-gray-200 rounded-lg text-sm focus:ring-2 focus:ring-gray-400 outline-none font-bold"
                                disabled={readOnly}>
                                <option value="">--</option>
                                <option value="YES">YES</option>
                ...
                {/* Final Diagnosis + Consultants */}
                <div className="bg-white rounded-xl p-3 shadow-sm border border-gray-100">
                    <div className="space-y-2.5">
                        <div>
                            <label className="text-[10px] font-black text-gray-500 uppercase tracking-widest">Final Diagnosis</label>
                        ...
                        <div className="grid grid-cols-4 gap-3">
                            <div className="col-span-3">
                                <label className="text-[10px] font-black text-gray-500 uppercase tracking-widest">Consultants</label>
                            ...
                            <div className="col-span-1">
                                <label className="text-[10px] font-black text-gray-500 uppercase tracking-widest">Room No.</label>
                                <input type="text" value={formData.roomNo || ''} onChange={e => setFormData((prev: any) => ({ ...prev, roomNo: e.target.value.toUpperCase() }))}
                                    className="w-full mt-1 px-3 py-2.5 border-2 border-gray-200 rounded-lg text-sm focus:ring-2 focus:ring-gray-400 outline-none uppercase font-bold text-gray-900"
                ...
                {/* Explained To Attender */}
                <div className="bg-white rounded-xl p-3 shadow-sm border border-gray-100">
                    <h3 className="font-black text-gray-900 text-sm mb-2">Explained To Attender</h3>
                    <div className="space-y-3">
                        <div>
                            <label className="text-[10px] font-semibold text-gray-500 uppercase tracking-wide">Explained By</label>
                            <input type="text" value={formData.explainedBy || ''} onChange={e => setFormData((prev: any) => ({ ...prev, explainedBy: e.target.value.toUpperCase() }))}
                                className="w-full mt-1 px-3 py-2.5 border border-gray-200 rounded-lg text-sm outline-none uppercase" placeholder="STAFF / DOCTOR NAME" readOnly={readOnly} />
                        </div>
                        <div>
                            <label className="text-[10px] font-semibold text-gray-500 uppercase tracking-wide">Attender Name</label>
                            <input type="text" value={formData.attenderName || ''} onChange={e => setFormData((prev: any) => ({ ...prev, attenderName: e.target.value.toUpperCase() }))}
                                className="w-full mt-1 px-3 py-2.5 border border-gray-200 rounded-lg text-sm outline-none uppercase" placeholder="ATTENDER FULL NAME" readOnly={readOnly} />
                        </div>
                    </div>
                </div>
...
export default MobileDischargeCardInput;
