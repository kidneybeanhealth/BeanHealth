            ...
            <div className="max-w-6xl mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-end mb-12">
                    ...
                    <div className="bg-white/40 border border-moss/10 p-10 rounded-[2.5rem] hover:bg-white/60 transition-all hover:-translate-y-2 duration-300 flex flex-col h-[500px]">
                        ...
                        <a href="#demo-section" className="w-full py-4 mt-8 rounded-full border border-moss/20 font-bold uppercase tracking-widest text-xs hover:bg-moss/5 transition-all active:scale-95 duration-300 text-moss hover:text-moss flex items-center justify-center">Get Started</a>
                    </div>
                    ...
                    <div className="bg-moss text-cream border border-moss p-10 rounded-[3rem] hover:shadow-2xl transition-all duration-500 flex flex-col h-[550px] relative transform hover:-translate-y-2 md:hover:-translate-y-6 md:-translate-y-4 shadow-xl">
                        ...
                        <a href="#demo-section" className="w-full py-4 mt-8 rounded-full bg-clay text-white font-bold uppercase tracking-widest text-xs hover:bg-clay/90 transition-all active:scale-95 duration-300 shadow-xl border border-clay flex items-center justify-center hover:text-white">Get Started</a>
                    </div>
                    ...
                    <div className="bg-white/40 border border-moss/10 p-10 rounded-[2.5rem] hover:bg-white/60 transition-all hover:-translate-y-2 duration-300 flex flex-col h-[500px]">
                        ...
                        <a href="#demo-section" className="w-full py-4 mt-8 rounded-full border border-moss/20 font-bold uppercase tracking-widest text-xs hover:bg-moss/5 transition-all active:scale-95 duration-300 text-moss hover:text-moss flex items-center justify-center">Contact Sales</a>
                    </div>
                </div>
