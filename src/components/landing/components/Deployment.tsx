            ...
            <div className="max-w-6xl mx-auto">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                    {[
                        ...
                        <div key={i} className="bg-white/40 p-8 rounded-[2rem] border border-moss/5 hover:border-moss/20 transition-all hover:-translate-y-2 duration-300 shadow-sm" style={{ willChange: 'transform' }}>
