    ...
    return (
        <div className="bg-white dark:bg-[#8AC43C]/[0.08] backdrop-blur-md p-3 sm:p-4 rounded-xl sm:rounded-2xl shadow-[0_6px_16px_rgba(0,0,0,0.06)] dark:shadow-[0_0_15px_rgba(138,196,60,0.1)] transition-all duration-300 border border-transparent dark:border-[#8AC43C]/20">
            <div className="flex items-center justify-between mb-2 sm:mb-3">
                <h3 className="text-base sm:text-lg md:text-xl font-bold text-[#222222] dark:text-white">{t.tests.title}</h3>
                <button
            ...
            <div className="space-y-2 sm:space-y-3 max-h-80 sm:max-h-96 overflow-y-auto scrollbar-hide">
                {allTests.length > 0 ? (
                    ...
                    <div className="text-center py-8 sm:py-12">
                        ...
                        <p className="text-xs sm:text-sm text-[#717171] dark:text-[#a0a0a0] font-bold tracking-tight">{t.tests.noTests}</p>
                        <p className="text-[10px] sm:text-xs text-[#717171] dark:text-[#a0a0a0] mt-1 font-medium">Click "{t.tests.add}" to add one</p>
                    </div>
                )}
            </div>
        </div>
