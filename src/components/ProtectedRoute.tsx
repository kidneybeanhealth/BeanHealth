...
const ProtectedRoute: React.FC<ProtectedRouteProps> = ({
    ...
    // If this is an enterprise route and the user is an enterprise user, 
    // automatically wrap it with the TenantProvider so all children get the tenant context
    if (profile?.role === 'enterprise' && allowedRoles?.includes('enterprise')) {
        return (
