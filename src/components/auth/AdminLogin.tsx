    ...
    return (
        <div className="space-y-6">
            ...
            <div className="flex items-center justify-center gap-2 py-3 rounded-xl bg-gray-50 border border-gray-100">
                ...
                <span className="text-xs font-medium !text-gray-500">Authorized personnel only</span>
            </div>

            {/* Back Button */}
            <button
                onClick={onSwitchToChooser}
                className="w-full flex items-center justify-center gap-2 py-3 transition-colors !text-gray-400 hover:text-gray-600"
            >
