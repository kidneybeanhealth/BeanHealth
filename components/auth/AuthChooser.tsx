...
const AuthChooser: React.FC<AuthChooserProps> = ({ onNext, onEnterpriseLogin: onAdminLogin, onClinicLogin }) => {
        ...
        <div className="space-y-6">
            ...
            <div className="space-y-3">
                ...
                <button
                    ...
                    className="w-full p-4 rounded-2xl border-2 border-gray-200 bg-white hover:border-primary-500/50 hover:shadow-md transition-all duration-200 text-left flex items-center gap-4 group"
                >
