            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                ...
                >
                    ...
                    <div className="flex flex-col space-y-6">
                        ...
                        <div className="pt-2 space-y-2">
                            <div className={`flex items-center gap-2 text-sm ${selectedRole === 'patient' ? 'text-white/80 dark:text-white/80' : 'text-gray-600 dark:text-gray-400'}`}>
                ...
                >
                    ...
                    <div className="flex flex-col space-y-6">
                        ...
                        {/* Features List */}
                        <div className="pt-2 space-y-2">
                            <div className={`flex items-center gap-2 text-sm ${selectedRole === 'doctor' ? 'text-white/80 dark:text-white/80' : 'text-gray-600 dark:text-gray-400'}`}>
                                <svg className="w-4 h-4 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                                </svg>
