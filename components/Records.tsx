                ...
                <div className="bg-gray-100 dark:bg-gray-700 p-3 sm:p-4 rounded-xl sm:rounded-2xl transition-transform duration-300 group-hover:scale-110 flex-shrink-0">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex flex-col sm:flex-row justify-between sm:items-start mb-2 sm:mb-3 gap-2">
                      <div className="flex-1 min-w-0">
                        <div className={`inline-flex items-center px-2.5 sm:px-3 py-1 sm:py-1.5 rounded-lg sm:rounded-xl text-xs font-medium border mb-2 sm:mb-3 ${getCategoryColor(record.category)}`}>
                    ...
                    <div className="flex items-center gap-2 opacity-100 sm:opacity-0 group-hover:opacity-100 transition-opacity duration-200 flex-shrink-0">
                      {record.fileUrl && (
                        <a
                          ...
                          className="p-2 sm:p-3 rounded-lg sm:rounded-xl bg-gray-100 dark:bg-gray-700 text-gray-600 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-gray-600 transition-all duration-200"
                      ...
                      <button
                        ...
                        className="p-2 sm:p-3 rounded-lg sm:rounded-xl bg-red-50 dark:bg-red-900/20 text-red-600 dark:text-red-400 hover:bg-red-100 dark:hover:bg-red-900/30 transition-all duration-200"
