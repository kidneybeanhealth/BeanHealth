        ...
        return (
          <div className="flex items-center space-x-3 p-3">
            ...
            <button
              ...
              className="flex items-center space-x-1 px-3 py-2 bg-blue-500 hover:bg-blue-600 disabled:bg-gray-400 disabled:cursor-not-allowed text-white rounded-lg text-xs font-medium transition-colors"
