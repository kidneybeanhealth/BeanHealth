              ...
              return (
                  ...
                  >
                      <div className="relative flex-shrink-0">
                          ...
                          <span className="absolute -bottom-0.5 -right-0.5 block h-3.5 w-3.5 rounded-full bg-secondary-500 ring-2 ring-white dark:ring-gray-800"></span>
                          {hasUnreadUrgent && (
        ...
        {selectedContact ? (
          <>
                ...
                <div className="relative flex-shrink-0">
                  ...
                  {isConnected && (
                    <span className="absolute bottom-0 right-0 flex h-3.5 w-3.5">
                      ...
                      <span className="relative inline-flex rounded-full h-3.5 w-3.5 bg-secondary-500 ring-2 ring-white dark:ring-gray-900"></span>
                    </span>
                  )}
                </div>
            ...
            <div className="relative px-4 sm:px-5 lg:px-6 py-3 sm:py-4 border-t border-gray-200/60 dark:border-gray-700/60 bg-white dark:bg-gray-900 flex-shrink-0 overflow-visible">
               ...
               {/* Upload Progress */}
               {uploadProgress && (
                 <div className="relative mb-4 p-4 bg-secondary-50 dark:bg-secondary-900/30 rounded-2xl border border-secondary-200 dark:border-secondary-700">
                   <div className="flex items-center justify-between text-sm text-secondary-800 dark:text-secondary-200 mb-3 font-semibold">
                     <span className="flex items-center">
                       <svg className="animate-spin h-5 w-5 mr-2 text-secondary-600 dark:text-secondary-400" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                         <circle className="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="4"></circle>
                         <path className="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
                       </svg>
                   ...
                   <div className="relative w-full bg-secondary-200 dark:bg-secondary-800 rounded-full h-3 overflow-hidden">
                     <div
                       className="absolute inset-0 bg-secondary-600 dark:bg-secondary-500 h-3 rounded-full transition-all duration-300"
              ...
              <form onSubmit={handleSendMessage} className="relative z-10 flex items-center gap-2">
                ...
                {input.trim() ? (
                  ...
                  <button
                    ...
                    className="flex-shrink-0 p-2.5 sm:p-2.5 rounded-full bg-secondary-500 dark:bg-secondary-600 text-white hover:scale-110 active:scale-95 transition-all duration-300"
