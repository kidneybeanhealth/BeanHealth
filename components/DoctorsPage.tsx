                            ...
                            >
                                ...
                                <div className="flex gap-1.5 flex-shrink-0 self-end sm:self-center">
                                    <button
                                        ...
                                        className="px-3 sm:px-4 py-1.5 sm:py-2 bg-[#222222] dark:bg-white text-white dark:text-[#222222] text-[10px] sm:text-xs font-bold rounded-full hover:opacity-90 transition-all shadow-sm active:scale-95"
                                    >
                                        Message
                                    </button>
                                    <button
